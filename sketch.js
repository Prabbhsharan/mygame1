...
function preload() {
  ...
  spaceShipImage = loadImage("download.png");
  laserImage = loadImage("laser.png");
  asteroid1 = loadImage("images.png");
...
function draw() {
  ...
  if(gameState === play) {
    ...
    text("The alien and virus have infected the residents of the Earth",canvas.width/2-400,canvas.height/2+100);
  ...
  if(gameState === instruction) {
    ...
    textSize(40);
    text("------CORONALIEN VIRUS SHOOTERS------",canvas.width/2-300,canvas.height/2-300);
    text("ENJOY THE GAME!",canvas.width/2-300,canvas.height/2+170);
    stroke(255);
    fill(255);
    textSize(25);
    textFont("Helvetica");
    text(" Year 2050.....",canvas.width/2-300,canvas.height/2-250);
    text(" aliens and virus are invading earth.",canvas.width/2-300, canvas.height/2 - 210);
    text(" You are a superhero.",canvas.width/2-300,canvas.height/2-170);
    ...
    text(" Shoot 50 enemies to protect the Earth and its residents.",canvas.width/2-300,canvas.height-350);
